...
export default {
  ...
  options: [
    ...
    { id: '12', label: 'Stars', type: 'datePicker', className: 'row' },
    { id: '13', label: 'Ends', type: 'datePicker', className: 'row', delay: true },
    ...
    { id: '20', label: 'Description', placeholder: 'Description', type: 'textarea' },
  ],
};
